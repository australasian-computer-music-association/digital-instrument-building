...
public final class OvertoneInst extends jm.audio.Instrument{
	...
	*/
	public void createChain(){
		// fundamental
		Oscillator osc0 = new Oscillator(this, Oscillator.SINE_WAVE, this.sampleRate,
			this.channels);
		Volume vol0 = new Volume(osc0,(float)1.0);
		// 1st harmonic
		Oscillator osc1 = new Oscillator(this, Oscillator.SINE_WAVE, this.sampleRate,
				   this.channels);
		osc1.setFrqRatio((float)2.0);
		Volume vol1 = new Volume(osc1,(float)0.5);
		// 2nd harmonic
		Oscillator osc2 = new Oscillator(this, Oscillator.SINE_WAVE, this.sampleRate,
				   this.channels);
		osc2.setFrqRatio((float)3.0);
		Volume vol2 = new Volume(osc2,(float)0.25);
		// 3nd harmonic
		Oscillator osc3 = new Oscillator(this, Oscillator.SINE_WAVE, this.sampleRate,
				   this.channels);
